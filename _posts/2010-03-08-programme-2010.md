...
Tomislav Tipuri, Visual Studio Product Manager, Microsoft Croatia- 
### Visual Studio 2010 testing tools
Youve probably heard about Visual Studio. It is and IDE from Microsoft, not a testing tool& But, newest set of tools in Visual Studio turns Visual Studio into stunning test environment. It lets you create automated test for your application UI, it supports manual testing, testcase management&.
