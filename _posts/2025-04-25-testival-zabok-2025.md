...
![](https://re-generator.hr/wp-content/uploads/2023/09/regenerator-logo-white.png)
...
We follow an **unconference format** , where attendees actively shape the event by proposing and voting on sessions, workshops, and discussions.
...
- QA engineers
- Agile practitioners
- Students & anyone curious about testing

Whether you're a seasoned professional or just starting your journey, Testival welcomes **everyone** with an interest in quality software.
...
- Networking over coffee and lunch!

* * *

### Registration

Testival is **completely free** , but registration is required due to limited space. Registration will open very soon, so be sure to follow [https://testival.eu](https://testival.eu/) and our social channels for updates.
